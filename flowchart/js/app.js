...
angular.module('flowchartApp', ['flowchart'])
    ...
    .controller('FlowchartCtrl', function AppCtrl($scope, Modelfactory, flowchartConstants) {
        ...
        (function ($) {
            $(document).ready(function () {
                ...
                $('.flowchart .button-control').not( " .edit-btn" ).on("click", function () {
                ...
                $('.flowchart .done').on("click", function () {
                    ...
                    $('.flowchart .startForm ').append(' <label for="1">1 Answer</label> <input class="answer" id="1" type="text">');
                ...
                $('.flowchart .edit-answer').on("click", function () {
                    if (!$(this).attr('disabled')) {
                        ...
                        $('.flowchart .fc-selected .fc-bottomConnectors .conditionItem ').each(function (index) {
                                ...
                                $('.flowchart .startForm ').append(' <label for=" + connectorValLeng  +">' + connectorValLeng  + ' Answer</label> <input value="' + connectorVal[index] + '" class="answer" id=" + connectorValLeng  +" type="text">');
                                return connectorVal;
                        });
                        connectorValLeng++;
                        $('.flowchart .startForm ').append(' <label for=" + connectorValLeng  +">' + connectorValLeng   + ' Answer</label> <input value="" class="answer" id=" + connectorValLeng +" type="text">');
                        $('.flowchart .add').addClass('disabled');
                ...
                $('.flowchart .edit-question').on("click", function () {
                    if (!$(this).attr('disabled')) {
                        $('.flowchart .settingsPopUp-wrap').addClass('disabled')
                    }
                });
                })
        })(jQuery);
