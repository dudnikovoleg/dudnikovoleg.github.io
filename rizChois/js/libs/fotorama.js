                ...
                cb(a, b, function(a, c, e, f, g, h) {
                    if (!f) {
                        f = e[g] = qe[g].clone(), h = f.data(), h.data = e;
                            ...
                            var size = 18,
                                TextValid = e.caption.replace(/\s+/g, ' '),
                                TextLength = TextValid.split(' ').length,
                                TextArr = TextValid.split(' ', size),
                        ...
                        var i = f[0];
                        "stage" === b ? (e.html && d('<div class="' + kc + '"></div>').append(e._html ? d(e.html).removeAttr("id").html(e._html) : e.html).appendTo(f),  TextStr + dotts && d(N(oc, N(pc,  TextStr + dotts))).appendTo(f), e.video && f.addClass(zb).append(Fe.clone()), X(i, function() {
                            setTimeout(function() {
                                Q(re)
                            }, 0), pd({
                                index: h.eq,
